...
const Discount = () => {
  return (
    <div>
      <div className="p-6 py-8 md:py-20 dark:bg-violet-600 dark:text-gray-50 rounded-2xl">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center  lg:justify-between">
            <h2 className="text-center lg:text-6xl text-4xl tracking-tighter font-bold">
              Up to
              <br className="" /> 30% Off
            </h2>
