...
const Home = () => {
  ...
  return (
    <div className="home-page ">
      <div className="bg-linear-to-r from-indigo-50 via-white to-indigo-50 px-12 ">
...
<p className="text-center mb-8 text-sm md:text-md lg:w-2/4 mx-auto ">Connect with locals to exchange today’s most popular skills in a trusted space. Turn your talents into opportunities with an easy-to-use local skills marketplace.</p>
     ...
     <div className="bg-linear-to-r from-indigo-50 via-white to-indigo-50">
      <div className="max-w-10/12 mx-auto px-12 pb-6">
        <Discount/>
      </div>
      </div>
<div className="bg-linear-to-r from-indigo-50 via-white to-indigo-50">
      <div className="max-w-10/12 mx-auto px-12 ">
        <TopCourseMarquee/>
      </div>
</div>
     <div className="bg-linear-to-r from-indigo-50 via-white to-indigo-50">
      ...
      <div className="bg-linear-to-r from-indigo-50 via-white to-indigo-50">
        <h1 className="text-2xl lg:pt-20 underline pt-10 text-center font-bold text-[#2f2f2f] lg:text-4xl">Frequently Ask Question</h1>
        <FAQ/>
      </div>
